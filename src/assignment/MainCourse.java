...
/**
 * Contains the details of a main course item in the menu, namely name, description, 
...
public class MainCourse implements MenuItem
{
	...
	public MainCourse(String name, String description, boolean exist, float price)
	{
		this.name=name;
